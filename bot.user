...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            $.get('https://raw.githubusercontent.com/orhan34/agar.io-bot-2015/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                {
                    update("aposBot", "bot.user.js", "https://github.com/orhan34/agar.io-bot-2015/blob/" + sha + "/bot.user.js/");
                }
